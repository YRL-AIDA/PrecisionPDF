...
public class Ruling extends Line2D.Float {
    ...
    public static int DISTANCE_TOLERANCE = 10;
    ...
    public Ruling(Point2D.Float startPoint, Point2D.Float endPoint) {
        super(startPoint, endPoint);
        //this.startPoint = startPoint;
        //this.endPoint = endPoint;
        this.renderingType = RenderingType.VISIBLE;
    }

    public Ruling(float left, float top, float right, float bottom) {
        this(new Point2D.Float(left, top), new Point2D.Float(right, bottom));
    }
